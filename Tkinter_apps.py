...
class Myroot(tk.Tk):
    def __init__(self):
        ...
        tk.Button (self.frame, text = 'Solar system', highlightbackground = '#ffa46d', highlightthickness=6 , command = Solar_system.solar.main_import, pady = 20, padx = 30).pack(pady = 10, padx = 30, ipadx = 39)
